...
#ifndef NuskySERVER_LOG_H
#define NuskySERVER_LOG_H
...
#define NC_LOG_MESSAGE_BODY(level__, call__, filterType__, ...)     \
        do {                                                        \
...
#define NC_LOG_TRACE(filterType__, ...) \
    NC_LOG_MESSAGE_BODY(LOG_LEVEL_TRACE, outTrace, filterType__, __VA_ARGS__)

#define NC_LOG_DEBUG(filterType__, ...) \
    NC_LOG_MESSAGE_BODY(LOG_LEVEL_DEBUG, outDebug, filterType__, __VA_ARGS__)

#define NC_LOG_INFO(filterType__, ...)  \
    NC_LOG_MESSAGE_BODY(LOG_LEVEL_INFO, outInfo, filterType__, __VA_ARGS__)

#define NC_LOG_WARN(filterType__, ...)  \
    NC_LOG_MESSAGE_BODY(LOG_LEVEL_WARN, outWarn, filterType__, __VA_ARGS__)

#define NC_LOG_ERROR(filterType__, ...) \
    NC_LOG_MESSAGE_BODY(LOG_LEVEL_ERROR, outError, filterType__, __VA_ARGS__)

#define NC_LOG_FATAL(filterType__, ...) \
    NC_LOG_MESSAGE_BODY(LOG_LEVEL_FATAL, outFatal, filterType__, __VA_ARGS__)
