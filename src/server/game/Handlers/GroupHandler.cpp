...
{
    NC_LOG_DEBUG("network", "WORLD: sending SMSG_GROUP_INVITE");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_INVITE");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_INVITE_RESPONSE");
    ...
    if (accept)
    {
        ...
        {
            NC_LOG_ERROR("network", "HandleGroupAcceptOpcode: player %s(%d) tried to accept an invite to his own group", GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
            return;
        }
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE_GUID");
    ...
    {
        NC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteGuidOpcode: leader %s(%d) tried to uninvite himself from the group.",
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_LEADER");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_ROLES");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DISBAND");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_LOOT_METHOD");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_MINIMAP_PING");
    ...
    //NC_LOG_DEBUG("misc", "Received opcode MSG_MINIMAP_PING X: %f, Y: %f", x, y);
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_RANDOM_ROLL");
    ...
    //NC_LOG_DEBUG("misc", "ROLL: MIN: %u, MAX: %u, ROLL: %u", minimum, maximum, roll);
...
{
    NC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_TARGET_UPDATE");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_RAID_CONVERT");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_CHANGE_SUB_GROUP");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SWAP_SUB_GROUP");
    std::string unk1;
    std::string unk2;
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ASSISTANT_LEADER");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_SET_EVERYONE_IS_ASSISTANT");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received MSG_PARTY_ASSIGNMENT");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_RAID_READY_CHECK");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_RAID_READY_CHECK_CONFIRM");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    ObjectGuid guid;
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_OPT_OUT_OF_LOOT");
    ...
    {
        if (passOnLoot)
            NC_LOG_ERROR("network", "CMSG_OPT_OUT_OF_LOOT value<>0 for not-loaded character!");
        return;
    }
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_INITIATE_ROLE_POLL");
