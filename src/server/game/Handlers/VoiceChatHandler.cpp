...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_VOICE_SESSION_ENABLE");
...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_CHANNEL_VOICE_ON");
...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_SET_ACTIVE_VOICE_CHANNEL");
