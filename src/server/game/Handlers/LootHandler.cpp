...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_AUTOSTORE_LOOT_ITEM");
...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_LOOT_MONEY");
...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_LOOT");
...
{
    NC_LOG_DEBUG("network", "WORLD: CMSG_LOOT_RELEASE");
...
void WorldSession::HandleLootMasterGiveOpcode(WorldPacket& recvData)
{
    ...
    NC_LOG_DEBUG("network", "WorldSession::HandleLootMasterGiveOpcode (CMSG_LOOT_MASTER_GIVE, 0x02A3) Target = [%s].", target->GetName().c_str());
    ...
    {
        NC_LOG_DEBUG("loot", "MasterLootItem: Player %s might be using a hack! (slot %d, size %lu)",
