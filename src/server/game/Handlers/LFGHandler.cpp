...
void WorldSession::HandleLfgJoinOpcode(WorldPacket& recvData)
{
    ...
    if (!numDungeons)
    {
        NC_LOG_DEBUG("lfg", "CMSG_LFG_JOIN %s no dungeons selected", GetPlayerInfo().c_str());
        recvData.rfinish();
        return;
    }
    ...
    NC_LOG_DEBUG("lfg", "CMSG_LFG_JOIN %s roles: %u, Dungeons: %u, Comment: %s",
...
void WorldSession::HandleLfgLeaveOpcode(WorldPacket& recvData)
{
    ...
    NC_LOG_DEBUG("lfg", "CMSG_LFG_LEAVE %s in group: %u sent guid " UI64FMTD ".",
...
void WorldSession::HandleLfgProposalResultOpcode(WorldPacket& recvData)
{
    ...
    NC_LOG_DEBUG("lfg", "CMSG_LFG_PROPOSAL_RESULT %s proposal: %u accept: %u",
...
void WorldSession::HandleLfgSetRolesOpcode(WorldPacket& recvData)
{
    ...
    if (!group)
    {
        NC_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES %s Not in group",
            GetPlayerInfo().c_str());
        return;
    }
    uint64 gguid = group->GetGUID();
    NC_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES: Group %u, Player %s, Roles: %u",
...
void WorldSession::HandleLfgSetCommentOpcode(WorldPacket&  recvData)
{
    ...
    NC_LOG_DEBUG("lfg", "CMSG_LFG_SET_COMMENT %s comment: %s",
...
void WorldSession::HandleLFDSetBootVoteOpcode(WorldPacket& recvData)
{
    ...
    uint64 guid = GetPlayer()->GetGUID();
    NC_LOG_DEBUG("lfg", "CMSG_LFD_SET_BOOT_VOTE %s agree: %u",
...
void WorldSession::HandleLFDTeleportOpcode(WorldPacket& recvData)
{
    ...
    NC_LOG_DEBUG("lfg", "CMSG_LFD_TELEPORT %s out: %u",
...
void WorldSession::HandleLFDGetLockInfoOpcode(WorldPacket& recvData)
{
    ...
    NC_LOG_DEBUG("lfg", "CMSG_LFD_LOCK_INFO_REQUEST %s for %s", GetPlayerInfo().c_str(), (forPlayer ? "player" : "party"));
...
void WorldSession::SendLfgPlayerLockInfo()
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_INFO %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgPartyLockInfo()
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_PARTY_INFO %s", GetPlayerInfo().c_str());
...
void WorldSession::HandleLfrJoinOpcode(WorldPacket& recvData)
{
    ...
    recvData >> entry;
    NC_LOG_DEBUG("lfg", "CMSG_LFG_LFR_JOIN %s dungeon entry: %u",
...
void WorldSession::HandleLfrLeaveOpcode(WorldPacket& recvData)
{
    ...
    recvData >> dungeonId;
    NC_LOG_DEBUG("lfg", "CMSG_LFG_LFR_LEAVE %s dungeonId: %u",
...
{
    NC_LOG_DEBUG("lfg", "CMSG_LFG_GET_STATUS %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgUpdateStatus(lfg::LfgUpdateData const& updateData, bool party)
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_STATUS %s updatetype: %u, party %s",
...
{
    NC_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHOSEN %s guid: %u roles: %u",
...
void WorldSession::SendLfgRoleCheckUpdate(lfg::LfgRoleCheck const& roleCheck)
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHECK_UPDATE %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgJoinResult(lfg::LfgJoinResultData const& joinData)
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_JOIN_RESULT %s checkResult: %u checkValue: %u",
...
{
    NC_LOG_DEBUG("lfg", "SMSG_LFG_QUEUE_STATUS %s dungeon: %u, waitTime: %d, "
...
void WorldSession::SendLfgPlayerReward(lfg::LfgPlayerRewardData const& rewardData)
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_REWARD %s rdungeonEntry: %u, sdungeonEntry: %u, done: %u",
...
void WorldSession::SendLfgBootProposalUpdate(lfg::LfgPlayerBoot const& boot)
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_BOOT_PROPOSAL_UPDATE %s inProgress: %u - "
...
void WorldSession::SendLfgUpdateProposal(lfg::LfgProposal const& proposal)
{
    ...
    NC_LOG_DEBUG("lfg", "SMSG_LFG_PROPOSAL_UPDATE %s state: %u",
...
{
    NC_LOG_DEBUG("lfg", "SMSG_LFG_LFR_LIST %s update: %u",
...
{
    NC_LOG_DEBUG("lfg", "SMSG_LFG_DISABLED %s", GetPlayerInfo().c_str());
...
{
    NC_LOG_DEBUG("lfg", "SMSG_LFD_OFFER_CONTINUE %s dungeon entry: %u",
...
{
    NC_LOG_DEBUG("lfg", "SMSG_LFD_TELEPORT_DENIED %s reason: %u",
...
{
    NC_LOG_DEBUG("network", "SMSG_LFG_UPDATE_LIST %s dungeon entry: %u",
        GetPlayerInfo().c_str(), dungeonEntry);
