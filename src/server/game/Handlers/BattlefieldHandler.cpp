...
void WorldSession::HandleBfQueueInviteResponse(WorldPacket& recvData)
{
    ...
    NC_LOG_ERROR("misc", "HandleQueueInviteResponse: GUID:" UI64FMTD " Accepted:%u", (uint64)guid, accepted);
...
void WorldSession::HandleBfEntryInviteResponse(WorldPacket& recvData)
{
    ...
    NC_LOG_ERROR("misc", "HandleBattlefieldInviteResponse: GUID:" UI64FMTD " Accepted:%u", (uint64)guid, accepted);
...
void WorldSession::HandleBfExitRequest(WorldPacket& recvData)
{
    ...
    NC_LOG_ERROR("misc", "HandleBfExitRequest: GUID:" UI64FMTD " ", (uint64)guid);
