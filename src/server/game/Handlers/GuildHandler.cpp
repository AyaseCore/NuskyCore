...
void WorldSession::HandleGuildQueryOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_ERROR("guild", "CMSG_GUILD_QUERY [%s]: Guild: %u Target: %u",
...
void WorldSession::HandleGuildInviteOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_INVITE [%s]: Invited: %s", GetPlayerInfo().c_str(), invitedName.c_str());
...
void WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_REMOVE [%s]: Target: %u", GetPlayerInfo().c_str(), GUID_LOPART(playerGuid));
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_ACCEPT [%s]", GetPlayerInfo().c_str());
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_DECLINE [%s]", GetPlayerInfo().c_str());
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_ROSTER [%s]", GetPlayerInfo().c_str());
    recvPacket.rfinish();
...
void WorldSession::HandleGuildPromoteOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_PROMOTE [%s]: Target: %u", GetPlayerInfo().c_str(), GUID_LOPART(targetGuid));
...
void WorldSession::HandleGuildDemoteOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_DEMOTE [%s]: Target: %u", GetPlayerInfo().c_str(), GUID_LOPART(targetGuid));
...
void WorldSession::HandleGuildAssignRankOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_ASSIGN_MEMBER_RANK [%s]: Target: %u Rank: %u, Issuer: %u",
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_LEAVE [%s]", GetPlayerInfo().c_str());
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_DISBAND [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildMOTDOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_MOTD [%s]: MOTD: %s", GetPlayerInfo().c_str(), motd.c_str());
...
void WorldSession::HandleGuildSetNoteOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_SET_NOTE [%s]: Target: %u, Note: %s, Public: %u",
...
void WorldSession::HandleGuildQueryRanksOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_QUERY_RANKS [%s]: Guild: %u",
...
void WorldSession::HandleGuildAddRankOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_ADD_RANK [%s]: Rank: %s", GetPlayerInfo().c_str(), rankName.c_str());
...
void WorldSession::HandleGuildDelRankOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_DEL_RANK [%s]: Rank: %u", GetPlayerInfo().c_str(), rankId);
...
void WorldSession::HandleGuildChangeInfoTextOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_INFO_TEXT [%s]: %s", GetPlayerInfo().c_str(), info.c_str());
...
void WorldSession::HandleSaveGuildEmblemOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "MSG_SAVE_GUILD_EMBLEM [%s]: Guid: [" UI64FMTD"] Style: %d, Color: %d, BorderStyle: %d, BorderColor: %d, BackgroundColor: %d",
...
{
    NC_LOG_DEBUG("guild", "MSG_GUILD_EVENT_LOG_QUERY [%s]", GetPlayerInfo().c_str());
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_MONEY_WITHDRAWN [%s]", GetPlayerInfo().c_str());
...
{
    // Null Packet
    NC_LOG_DEBUG("guild", "CMSG_GUILD_PERMISSIONS [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildBankerActivate(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANKER_ACTIVATE [%s]: Go: [" UI64FMTD "] AllSlots: %u", GetPlayerInfo().c_str(), (uint64)guid, sendAllSlots);
...
void WorldSession::HandleGuildBankQueryTab(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_QUERY_TAB [%s]: Go: [" UI64FMTD "], TabId: %u, AllSlots: %u", GetPlayerInfo().c_str(), (uint64)guid, tabId, sendAllSlots);
...
void WorldSession::HandleGuildBankDepositMoney(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_DEPOSIT_MONEY [%s]: Go: [" UI64FMTD "], money: " UI64FMTD,
...
void WorldSession::HandleGuildBankWithdrawMoney(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_WITHDRAW_MONEY [%s]: Go: [" UI64FMTD "], money: " UI64FMTD,
        GetPlayerInfo().c_str(), (uint64)guid, money);
...
{
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_SWAP_ITEMS [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildBankBuyTab(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_BUY_TAB [%s]: Go: [" UI64FMTD "], TabId: %u", GetPlayerInfo().c_str(), (uint64)guid, tabId);
...
void WorldSession::HandleGuildBankUpdateTab(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_UPDATE_TAB [%s]: Go: [" UI64FMTD "], TabId: %u, Name: %s, Icon: %s",
...
void WorldSession::HandleGuildBankLogQuery(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "MSG_GUILD_BANK_LOG_QUERY [%s]: TabId: %u", GetPlayerInfo().c_str(), tabId);
...
void WorldSession::HandleQueryGuildBankTabText(WorldPacket &recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "MSG_QUERY_GUILD_BANK_TEXT [%s]: TabId: %u", GetPlayerInfo().c_str(), tabId);
...
void WorldSession::HandleSetGuildBankTabText(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_SET_GUILD_BANK_TEXT [%s]: TabId: %u, Text: %s", GetPlayerInfo().c_str(), tabId, text.c_str());
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_QUERY_GUILD_XP");
    ...
    NC_LOG_DEBUG("guild", "CMSG_QUERY_GUILD_XP [%s]: Guild: %u", GetPlayerInfo().c_str(), GUID_LOPART(guildGuid));
...
void WorldSession::HandleGuildSetRankPermissionsOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_SET_RANK_PERMISSIONS [%s]: Rank: %s (%u)", GetPlayerInfo().c_str(), rankName.c_str(), newRankId);
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_GUILD_REQUEST_PARTY_STATE");
...
void WorldSession::HandleGuildQueryNewsOpcode(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("guild", "CMSG_GUILD_QUERY_NEWS [%s]", GetPlayerInfo().c_str());
    if (Guild* guild = GetPlayer()->GetGuild())
