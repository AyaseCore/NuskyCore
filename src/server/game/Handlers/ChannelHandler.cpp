...
void WorldSession::HandleJoinChannel(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHAT_JOIN_CHANNEL %s Channel: %u, unk1: %u, unk2: %u, channel: %s, password: %s",
...
void WorldSession::HandleLeaveChannel(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_LEAVE_CHANNEL %s Channel: %s, unk1: %u",
...
void WorldSession::HandleChannelList(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "%s %s Channel: %s",
...
void WorldSession::HandleChannelPassword(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_PASSWORD %s Channel: %s, Password: %s",
...
void WorldSession::HandleChannelSetOwner(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_SET_OWNER %s Channel: %s, Target: %s",
...
void WorldSession::HandleChannelOwner(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_OWNER %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
...
void WorldSession::HandleChannelModerator(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_MODERATOR %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmoderator(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMODERATOR %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelMute(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_MUTE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmute(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMUTE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelInvite(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_INVITE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelKick(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_KICK %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelBan(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_BAN %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnban(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNBAN %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelAnnouncements(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_ANNOUNCEMENTS %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
...
void WorldSession::HandleGetChannelMemberCount(WorldPacket &recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_GET_CHANNEL_MEMBER_COUNT %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
    ...
    if (ChannelMgr* cMgr = ChannelMgr::forTeam(GetPlayer()->GetTeam()))
    {
        if (Channel* channel = cMgr->GetChannel(channelName, GetPlayer()))
        {
            NC_LOG_DEBUG("chat.system", "SMSG_CHANNEL_MEMBER_COUNT %s Channel: %s Count: %u",
...
void WorldSession::HandleSetChannelWatch(WorldPacket& recvPacket)
{
    ...
    NC_LOG_DEBUG("chat.system", "CMSG_SET_CHANNEL_WATCH %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
