...
{
    NC_LOG_DEBUG("network", "MSG_INSPECT_ARENA_TEAMS");

    uint64 guid;
    recvData >> guid;
    NC_LOG_DEBUG("network", "Inspect Arena stats (GUID: %u TypeId: %u)", GUID_LOPART(guid), GuidHigh2TypeId(GUID_HIPART(guid)));
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_CREATE");
    ...
    {
        NC_LOG_ERROR("bg.arena", "Arena team create failed.");
        delete arenaTeam;
        return;
    }
...
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_INVITE");
    ...
    NC_LOG_DEBUG("bg.battleground", "Player %s Invited %s to Join his ArenaTeam", GetPlayer()->GetName().c_str(), invitedName.c_str());
    ...
    NC_LOG_DEBUG("network", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamAcceptOpcode(WorldPacket & /*recvData*/)
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEAVE");
...
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DISBAND");
...
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_REMOVE");
...
{
    NC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEADER");
