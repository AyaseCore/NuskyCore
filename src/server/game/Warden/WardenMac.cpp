...
void WardenMac::Init(WorldSession* pClient, BigNumber* K)
{
    ...
    */
    ...
    NC_LOG_DEBUG("warden", "Server side warden for client %u initializing...", pClient->GetAccountId());
...
void WardenMac::HandleData(ByteBuffer &buff)
{
    ...
    {
        NC_LOG_DEBUG("warden", "Handle data failed: SHA1 hash is wrong!");
        //found = true;
    }
    ...
    {
        NC_LOG_DEBUG("warden", "Handle data failed: MD5 hash is wrong!");
        //found = true;
    }
