...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_RELOAD_NUSKY_STRING                    = 704,
    ...
    RBAC_PERM_COMMAND_MUTEHISTORY                            = 808,
...
class RBACData
{
    public:
         ...
         *     NC_LOG_DEBUG("entities.player", "Failed to grant permission %u, already denied", permissionId);
         * @endcode
         */
         ...
         *     NC_LOG_DEBUG("entities.player", "Role Id %u does not exists", permissionId);
         * @endcode
         */
         ...
         *     NC_LOG_DEBUG("entities.player", "Permission %u succesfully removed", permissionId);
         * @endcode
         */
