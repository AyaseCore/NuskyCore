...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
        ...
        NC_LOG_DEBUG("scripts", "Creature %s (Entry: %u GUID: %u DB GUID: %u) is using AI type: %s.", creature->GetName().c_str(), creature->GetEntry(), creature->GetGUIDLow(), creature->GetDBTableGUIDLow(), ainame.c_str());
    ...
    GameObjectAI* SelectGameObjectAI(GameObject* go)
    {
        ...
        NC_LOG_DEBUG("scripts", "GameObject %u used AI is %s.", go->GetGUIDLow(), ainame.c_str());
