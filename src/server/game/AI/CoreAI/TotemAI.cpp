...
void TotemAI::UpdateAI(uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        Nusky::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        Nusky::UnitLastSearcher<Nusky::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
