...
// Nusky string ranges
#define MIN_NUSKY_STRING_ID            1                     // 'nusky_string'
#define MAX_NUSKY_STRING_ID            2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_NUSKY_STRING_ID   // 'db_script_string'
#define MAX_DB_SCRIPT_STRING_ID        2000010000
#define MIN_CREATURE_AI_TEXT_STRING_ID (-1)                  // 'creature_ai_texts'
#define MAX_CREATURE_AI_TEXT_STRING_ID (-1000000)

// Nusky Trainer Reference start range
#define Nusky_TRAINER_START_REF      200000

struct NuskyStringLocale
{
...
typedef UNORDERED_MAP<int32, NuskyStringLocale> NuskyStringLocaleContainer;
...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        {
            NC_LOG_INFO("server.loading", "Loading GO Start Quest Data...");
            LoadGameobjectQuestStarters();
            NC_LOG_INFO("server.loading", "Loading GO End Quest Data...");
            LoadGameobjectQuestEnders();
            NC_LOG_INFO("server.loading", "Loading Creature Start Quest Data...");
            LoadCreatureQuestStarters();
            NC_LOG_INFO("server.loading", "Loading Creature End Quest Data...");
        ...
        bool LoadNuskyStrings(char const* table, int32 min_value, int32 max_value);
        bool LoadNuskyStrings() { return LoadNuskyStrings("nusky_string", MIN_NUSKY_STRING_ID, MAX_NUSKY_STRING_ID); }
        ...
        NuskyStringLocale const* GetNuskyStringLocale(int32 entry) const
        {
            NuskyStringLocaleContainer::const_iterator itr = _trinityStringLocaleStore.find(entry);
            if (itr == _trinityStringLocaleStore.end()) return NULL;
            return &itr->second;
        }
        const char *GetNuskyString(int32 entry, LocaleConstant locale_idx) const;
        const char *GetNuskyStringForDBCLocale(int32 entry) const { return GetNuskyString(entry, DBCLocaleIndex); }
        ...
        ArchaeologyFindInfo const* GetRandomArchaeologyFindForDigsite(uint32 digsiteId)
        {
            ...
            return &Nusky::Containers::SelectRandomContainerElement(itr->second);
        }
    ...
    private:
        ...
        NuskyStringLocaleContainer _trinityStringLocaleStore;
...
bool LoadNuskyStrings(char const* table, int32 start_value = MAX_CREATURE_AI_TEXT_STRING_ID, int32 end_value = std::numeric_limits<int32>::min());
