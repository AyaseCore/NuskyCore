...
#ifndef Nusky_MAPMANAGER_H
#define Nusky_MAPMANAGER_H
...
class MapManager
{
    ...
    public:
        ...
        {
            return IsValidMAP(mapid, false) && Nusky::IsValidMapCoord(x, y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
        {
            return IsValidMAP(mapid, false) && Nusky::IsValidMapCoord(x, y, z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
        {
            return IsValidMAP(mapid, false) && Nusky::IsValidMapCoord(x, y, z, o);
        }
