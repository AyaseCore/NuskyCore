    ...
    public:
        ...
        class spell_ex_5581SpellScript : public SpellScript
        {
            ...
            void HandleBeforeCast()
            {
                ...
                NC_LOG_INFO("misc", "Caster just finished preparing the spell (cast bar has expired)");
            }
            ...
            void HandleOnCast()
            {
                ...
                NC_LOG_INFO("misc", "Spell is about to do take reagents, power, launch missile, do visuals and instant spell effects");
            }

            void HandleAfterCast()
            {
                NC_LOG_INFO("misc", "All immediate Actions for the spell are finished now");
            ...
            {
                NC_LOG_INFO("misc", "Spell %u with SPELL_EFFECT_DUMMY is just launched!", GetSpellInfo()->Id);
            }
            ...
            void HandleDummyLaunchTarget(SpellEffIndex /*effIndex*/)
            {
                ...
                NC_LOG_INFO("misc", "Spell %u with SPELL_EFFECT_DUMMY is just launched at it's target: " UI64FMTD "!", GetSpellInfo()->Id, targetGUID);
            }

            void HandleDummyHit(SpellEffIndex /*effIndex*/)
            {
                NC_LOG_INFO("misc", "Spell %u with SPELL_EFFECT_DUMMY has hit!", GetSpellInfo()->Id);
            }

            void HandleDummyHitTarget(SpellEffIndex /*effIndex*/)
            {
                NC_LOG_INFO("misc", "SPELL_EFFECT_DUMMY is hits it's target!");
            ...
            {
                NC_LOG_INFO("misc", "Spell is about to hit target!");
            }

            void HandleOnHit()
            {
                NC_LOG_INFO("misc", "Spell just hit target!");
            }

            void HandleAfterHit()
            {
                NC_LOG_INFO("misc", "Spell just finished hitting target!");
            }

            void FilterTargets(std::list<Unit*>& /*targetList*/)
            {
                // usually you want this call for Area Target spells
                NC_LOG_INFO("misc", "Spell is about to add targets from targetList to final targets!");
            }
...
class spell_ex_66244 : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_66244AuraScript : public AuraScript
        {
            ...
            {
                NC_LOG_INFO("misc", "Aura Effect is about to be applied on target!");
            ...
            {
                NC_LOG_INFO("misc", "Aura Effect is about to be removed from target!");
                // this hook allows you to prevent execution of AuraEffect handler, or to replace it with your own handler
                //PreventDefaultAction();
            }
            ...
            {
                NC_LOG_INFO("misc", "Aura Effect has just been applied on target!");
            ...
            {
                NC_LOG_INFO("misc", "Aura Effect has just been just removed from target!");
                Unit* target = GetTarget();
            ...
            {
                NC_LOG_INFO("misc", "Perioidic Aura Effect is does a tick on target!");
                Unit* target = GetTarget();
            ...
            {
                NC_LOG_INFO("misc", "Perioidic Aura Effect is now updated!");
            ...
            {
                NC_LOG_INFO("misc", "Amount of Aura Effect is being calculated now!");
            ...
            {
                NC_LOG_INFO("misc", "Periodic data of Aura Effect is being calculated now!");
            ...
            {
                NC_LOG_INFO("misc", "SpellMod data of Aura Effect is being calculated now!");
...
class spell_ex_absorb_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_absorb_auraAuraScript : public AuraScript
        {
            ...
            {
                NC_LOG_INFO("misc", "Our aura is now absorbing damage done to us!");
            ...
            {
                NC_LOG_INFO("misc", "Our aura has absorbed %u damage!", absorbAmount);
            }
...
class spell_ex_463 : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_463AuraScript : public AuraScript
        {
            ...
            {
                NC_LOG_INFO("misc", "Area aura checks if unit is a valid target for it!");
