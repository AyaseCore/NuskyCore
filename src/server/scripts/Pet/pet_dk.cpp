    ...
    public:
        ...
        struct npc_pet_dk_ebon_gargoyleAI : CasterAI
        {
            ...
            void InitializeAI() OVERRIDE
            {
                ...
                Nusky::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30.0f);
                Nusky::UnitListSearcher<Nusky::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
