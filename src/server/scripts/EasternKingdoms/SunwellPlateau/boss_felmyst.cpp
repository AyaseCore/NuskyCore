...
public:
    ...
    struct boss_felmystAI : public ScriptedAI
    {
        ...
        void DespawnSummons(uint32 entry)
        {
            ...
            Nusky::AllCreaturesOfEntryInRange check(me, entry, 100);
            Nusky::CreatureListSearcher<Nusky::AllCreaturesOfEntryInRange> searcher(me, templist, check);
            TypeContainerVisitor<Nusky::CreatureListSearcher<Nusky::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
