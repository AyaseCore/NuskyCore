...
public:
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "nusky_string",                  rbac::RBAC_PERM_COMMAND_RELOAD_NUSKY_STRING,               true,  &HandleReloadNuskyStringCommand,                "", },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadNuskyStringCommand(handler, "");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        NC_LOG_INFO("misc", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        NC_LOG_INFO("misc", "Re-Loading Scripts...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading config settings...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Access Requirement definitions...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Additional Achievement Criteria Data...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Achievement Reward Data...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Tavern Area Triggers...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading AreaTrigger teleport definitions...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Autobroadcasts...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading BlackMarket Templates...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading creature award reputation definitions...");
    ...
    {
        NC_LOG_INFO("misc", "Reloading creature summon groups...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            NC_LOG_INFO("misc", "Reloading creature template entry %u", entry);
    ...
    {
        NC_LOG_INFO("misc", "Loading Quests Relations... (`creature_queststarter`)");
    ...
    {
        NC_LOG_INFO("misc", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        NC_LOG_INFO("misc", "Loading Quests Relations... (`creature_questender`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `gossip_menu` Table!");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        NC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_queststarter`)");
    ...
    {
        NC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_questender`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Quest Area Triggers...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Quest Objectives...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Quest Objective Effects...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Quest Templates...");
        ...
        NC_LOG_INFO("misc", "Re-Loading GameObjects for quests...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    static bool HandleReloadNuskyStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        NC_LOG_INFO("misc", "Re-Loading nusky_string Table!");
        sObjectMgr->LoadNuskyStrings();
        handler->SendGlobalGMSysMessage("DB table `nusky_string` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadWardenactionCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        NC_LOG_INFO("misc", "Re-Loading warden_action Table!");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `npc_trainer` Table!");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `npc_vendor` Table!");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `points_of_interest` Table!");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Quest POI ..." );
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        NC_LOG_INFO("misc", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `reputation_reward_rate` Table!" );
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading `reputation_spillover_template` Table!" );
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Skill Discovery Table...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Skill Extra Item Table...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading SpellArea Data...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Required Data... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Groups...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Learn Spells...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Linked Spells...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Proc Event conditions...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Bonus Data...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell target coordinates...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Spell pet auras...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Page Texts...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Item Random Enchantments Table...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            NC_LOG_INFO("misc", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            NC_LOG_INFO("misc", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            NC_LOG_INFO("misc", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            NC_LOG_INFO("misc", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Script strings from `db_script_string`...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Graveyard-zone links...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Game Tele coordinates...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading disables table...");
        DisableMgr::LoadDisables();
        NC_LOG_INFO("misc", "Checking quest disables...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Achievement Reward Data...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Creature ...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Creature Texts...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Gameobject ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Gossip Menu Option ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Item ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales NPC Text ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Page Text ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Points Of Interest ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Quest ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Locales Quest Objective ... ");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        NC_LOG_INFO("misc", "Re-Loading Auctions...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading BlackMarket Auctions...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Creature Texts...");
    ...
    {
        NC_LOG_INFO("misc", "Re-Loading Smart Scripts...");
    ...
    {
        NC_LOG_INFO("misc", "Reloading vehicle_accessory table...");
    ...
    {
        NC_LOG_INFO("misc", "Reloading vehicle_template_accessory table...");
    ...
    {
        NC_LOG_INFO("misc", "Reloading phase_definitions table...");
    ...
    {
        NC_LOG_INFO("misc", "Reloading RBAC tables...");
