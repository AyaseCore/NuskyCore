        ...
        struct npc_crok_scourgebaneAI : public npc_escortAI
        {
            ...
            void WaypointStart(uint32 waypointId) OVERRIDE
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
                        ...
                        Nusky::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage) OVERRIDE
            {
                ...
                if (!_wipeCheckTimer)
                {
                    _wipeCheckTimer = 1000;
                    Player* player = NULL;
                    Nusky::AnyPlayerInObjectRangeCheck check(me, 60.0f);
                    Nusky::PlayerSearcher<Nusky::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
                            ...
                            Nusky::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
                ...
                while (uint32 eventId = Events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARNATH_PW_SHIELD:
                        {
                            ...
                            DoCast(Nusky::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
                ...
                Nusky::MostHPMissingInRange u_check(me, 60.0f, 0);
                Nusky::CreatureLastSearcher<Nusky::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(Nusky::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        class spell_frost_giant_death_plague_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                if (!targets.empty())
                {
                    WorldObject* target = Nusky::Containers::SelectRandomContainerElement(targets);
                    targets.clear();
    ...
    public:
        ...
        class spell_svalna_revive_champion_SpellScript : public SpellScript
        {
            ...
            void RemoveAliveTarget(std::list<WorldObject*>& targets)
            {
                ...
                Nusky::Containers::RandomResizeList(targets, 2);
            }
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/) OVERRIDE
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(Nusky::ObjectDistanceOrderPred(player));
                bool instant = false;
