    ...
    public:
        ...
        struct boss_hodirAI : public BossAI
        {
            ...
            void FlashFreeze()
            {
                ...
                Nusky::AnyUnfriendlyUnitInObjectRangeCheck checker(me, me, 100.0f);
                Nusky::UnitListSearcher<Nusky::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
            ...
            void UpdateAI(uint32 diff) OVERRIDE
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            std::list<Unit*> TargetList;
                            Nusky::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 30.0f);
                            Nusky::UnitListSearcher<Nusky::AnyFriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
