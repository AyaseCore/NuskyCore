    ...
    public:
        ...
        class spell_gen_cannibalize_SpellScript : public SpellScript
        {
            ...
            SpellCastResult CheckIfCorpseNear()
            {
                ...
                Nusky::AnyDeadUnitSpellTargetInRangeCheck check(caster, max_range, GetSpellInfo(), TARGET_CHECK_ENEMY);
                Nusky::WorldObjectSearcher<Nusky::AnyDeadUnitSpellTargetInRangeCheck> searcher(caster, result, check);
