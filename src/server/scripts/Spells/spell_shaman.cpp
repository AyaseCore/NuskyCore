...
class spell_sha_bloodlust : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_bloodlust_SpellScript : public SpellScript
        {
            ...
            {
                targets.remove_if(Nusky::UnitAuraCheck(true, SPELL_SHAMAN_SATED));
                targets.remove_if(Nusky::UnitAuraCheck(true, SPELL_HUNTER_INSANITY));
                targets.remove_if(Nusky::UnitAuraCheck(true, SPELL_MAGE_TEMPORAL_DISPLACEMENT));
            }
...
class spell_sha_heroism : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_heroism_SpellScript : public SpellScript
        {
            ...
            void RemoveInvalidTargets(std::list<WorldObject*>& targets)
            {
                targets.remove_if(Nusky::UnitAuraCheck(true, SPELL_SHAMAN_EXHAUSTION));
                targets.remove_if(Nusky::UnitAuraCheck(true, SPELL_HUNTER_INSANITY));
                targets.remove_if(Nusky::UnitAuraCheck(true, SPELL_MAGE_TEMPORAL_DISPLACEMENT));
            }
