        ...
        class spell_dru_ravage_SpellScript : public SpellScript
        {
            ...
            void HandleOnHit()
            {
                if (Player* _player = GetCaster()->ToPlayer())
                    ...
                    {
                        _player->CastSpell(target, 58180, true);
                        if (_player->HasAura(81022))
                            _player->RemoveAura(81022);
                    }
            }
        ...
        class spell_dru_t10_restoration_4p_bonus_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                else
                {
                    ...
                    Unit* target = Nusky::Containers::SelectRandomContainerElement(tempTargets);
                    targets.clear();
