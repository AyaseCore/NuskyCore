    ...
    public:
        ...
        struct boss_kaelthasAI : public ScriptedAI
        {
            ...
            void StartEvent()
            {
                ...
                {
                    NC_LOG_ERROR("scripts", "Kael'Thas One or more advisors missing, Skipping Phases 1-3");
                    ...
                    case 3:
                    {
                        if (PhaseSubphase == 0)
                        {
                            ...
                            for (uint8 i = 0; i < MAX_ADVISORS; ++i)
                            {
                                ...
                                if (!Advisor)
                                    NC_LOG_ERROR("scripts", "SD2: Kael'Thas Advisor %u does not exist. Possibly despawned? Incorrectly Killed?", i);
                                else
                    ...
                    case 6:
                    {
                        ...
                        if (!InGravityLapse && !ChainPyros && Phase != 5)
                        {
                            ...
                            if (MindControl_Timer <= diff)
                            {
                                ...
                                {
                                    NC_LOG_DEBUG("scripts", "Kael'Thas mind control not supported.");
