...
public:
    ...
    struct npc_geezleAI : public ScriptedAI
    {
        ...
        void CompleteQuest()
        {
            ...
            Nusky::AnyPlayerInObjectRangeCheck checker(me, radius);
            Nusky::PlayerListSearcher<Nusky::AnyPlayerInObjectRangeCheck> searcher(me, players, checker);
        ...
        void DespawnNagaFlag(bool despawn)
        {
            ...
            if (!FlagList.empty())
            {
                ...
                NC_LOG_ERROR("scripts", "SD2 ERROR: FlagList is empty!");
        }
