...
public:
    ...
    struct instance_the_black_morass_InstanceMapScript : public InstanceScript
    {
        ...
        void SetData(uint32 type, uint32 data) OVERRIDE
        {
            ...
            case TYPE_MEDIVH:
                ...
                else
                {
                    if (data == IN_PROGRESS)
                    {
                        NC_LOG_DEBUG("scripts", "Instance The Black Morass: Starting event.");
                        InitWorldState();
                    ...
                    if (data == DONE)
                    {
                        ...
                        NC_LOG_DEBUG("scripts", "Instance The Black Morass: Event completed.");
        ...
        Creature* SummonedPortalBoss(Creature* me)
        {
            ...
            NC_LOG_DEBUG("scripts", "Instance The Black Morass: Summoning rift boss entry %u.", entry);
            ...
            NC_LOG_DEBUG("scripts", "Instance The Black Morass: What just happened there? No boss, no loot, no fun...");
            return NULL;
        }
        ...
        void DoSpawnPortal()
        {
            if (Creature* medivh = instance->GetCreature(_medivhGUID))
            {
                ...
                NC_LOG_DEBUG("scripts", "Instance The Black Morass: Creating Time Rift at locationId %i (old locationId was %u).", tmp, _currentRiftId);
