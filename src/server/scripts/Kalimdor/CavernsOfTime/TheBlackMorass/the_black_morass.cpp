...
public:
    ...
    struct npc_time_riftAI : public ScriptedAI
    {
        ...
        void DoSelectSummon()
        {
            ...
            NC_LOG_DEBUG("scripts", "npc_time_rift: summoning wave Creature (Wave %u, Entry %u).", mRiftWaveCount, entry);
        ...
        void UpdateAI(uint32 diff) OVERRIDE
        {
            ...
            NC_LOG_DEBUG("scripts", "npc_time_rift: not casting anylonger, i need to die.");
