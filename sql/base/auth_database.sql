...
CREATE TABLE `account` (
  ...
  `hasBoost` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `realmlist` VALUES (1,'NuskyCore 5.4.8 18414','127.0.0.1','127.0.0.1','255.255.255.0',8085,1,0,1,0,0,18414);
...
CREATE TABLE `uptime` (
  ...
  `revision` varchar(255) NOT NULL DEFAULT 'NuskyCore',
...
-- Dump completed on 2015-01-21 17:39:54
