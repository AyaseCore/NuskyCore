# Copyright (C) 2011-2018 NuskyCore <http://www.nuskycore.org/
...
message("")
message("* NuskyCore revision   : ${rev_hash} ${rev_date} (${rev_branch} branch)")
if( UNIX )
  message("* NuskyCore buildtype  : ${CMAKE_BUILD_TYPE}")
endif()
message("")
