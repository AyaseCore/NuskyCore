...
if(COMPILER_SUPPORTS_CXX14)
  ...
  message(FATAL_ERROR "Error, NuskyCore requires a compiler that supports C++14!")
endif()

set(MSVC_EXPECTED_VERSION 19.0)

if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS MSVC_EXPECTED_VERSION)
  message(FATAL_ERROR "MSVC: NuskyCore requires version ${MSVC_EXPECTED_VERSION} (MSVC 2017) to build but found ${CMAKE_CXX_COMPILER_VERSION}")
endif()
